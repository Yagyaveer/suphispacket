...
--[[
	...
	F16		Â±2048					[65520]
	F24		Â±262144					[4294959104]
	F32		Â±16777216				[170141183460469231731687303715884105728]
	F64		Â±9007199254740992		[huge]
]]
-- Types
export type Cursor = {
	Buffer: buffer,
...
reads.EnumItem = function()
	local bitOffset = bufferOffset * 8
	bufferOffset += 3
	return enums[buffer.readbits(activeBuffer, bitOffset + 0, 12)]:FromValue(
		buffer.readbits(activeBuffer, bitOffset + 12, 12)
	)
end
...
local characters = require(script.Parent.dependencies.Characters)
...
local staticIndices = {}
local statics = require(script.Parent.dependencies.Static1)
...
local staticIndices = {}
local statics = require(script.Parent.dependencies.Static2)
for index, static in statics do
	staticIndices[static] = index
end
...
local staticIndices = {}
local statics = require(script.Parent.dependencies.Static3)
for index, static in statics do
	staticIndices[static] = index
end
